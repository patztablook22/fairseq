...
class TransformerModularModel(TransformerModelBase):
    ...
    Args:
        encoder (TransformerModularEncoder): the encoder
        decoder (TransformerModularDecoder): the decoder
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return TransformerModularEncoder(cfg, src_dict, embed_tokens)
...
class TransformerModularEncoder(TransformerEncoderBase):
    """
...
class TransformerModularDecoder(TransformerDecoderBase):
    """

...
class MaskedMultiheadAttention(MultiheadAttention):
    ...
    def _xformers_attn_forward(
        ...
        # TODO: Implement masked attention in XFormers to use here
        raise NotImplementedError("MaskedMultiheadAttention does not support XFormers at the moment...")
    ...
    def forward(
        ...
        if saved_state is not None:
            ...
            key_padding_mask = MaskedMultiheadAttention._append_prev_key_padding_mask(
